...
const SingleProductPage = () => {
  ...
  const [selectedDiameterConfig, setSelectedDiameterConfig] =
    useState<AvailableDiameterConfig | null>(null);
        ...
        <div className="mx-auto mt-8 max-w-2xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          ...
          <div className="mt-10">
            <button
              ...
              className="flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
              Add to Cart
            </button>
          </div>
